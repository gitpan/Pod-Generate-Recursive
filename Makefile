# This Makefile is for the Pod::Generate::Recursive extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Pod/Generate/Recursive.pm]
#     AUTHOR => [q[Adam M Dutko <addutko@cpan.org>]]
#     BUILD_REQUIRES => { Test::More=>q[0] }
#     CONFIGURE_REQUIRES => { ExtUtils::MakeMaker=>q[0] }
#     LICENSE => q[Perl_5]
#     MIN_PERL_VERSION => q[5.006]
#     NAME => q[Pod::Generate::Recursive]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0] }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/Pod/Generate/Recursive.pm]
#     clean => { FILES=>q[Pod-Generate-Recursive-*] }
...
NAME_SYM = Pod_Generate_Recursive
VERSION = 0.01
...
PERL_LIB = /opt/local/lib/perl5/5.16.3
...
MAKEMAKER   = /Users/adutko/perl5/lib/perl5/ExtUtils/MakeMaker.pm
MM_VERSION  = 6.98
MM_REVISION = 69800
...
MAKE = make
FULLEXT = Pod/Generate/Recursive
BASEEXT = Recursive
PARENT_NAME = Pod::Generate
DLBASE = $(BASEEXT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Pod/Generate/Recursive.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Pod/Generate
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Pod/Generate
...
TO_INST_PM = lib/Pod/Generate/Recursive.pm

PM_TO_BLIB = lib/Pod/Generate/Recursive.pm \
...
DISTNAME = Pod-Generate-Recursive
DISTVNAME = Pod-Generate-Recursive-0.01
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Pod/Generate/Recursive.pm $(INST_MAN3DIR)/Pod::Generate::Recursive.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''Generate POD for directory contents. '\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '  - '\''Adam M Dutko <addutko@cpan.org>'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'build_requires:' >> META_new.yml
	$(NOECHO) $(ECHO) '  Test::More: 0' >> META_new.yml
	$(NOECHO) $(ECHO) 'configure_requires:' >> META_new.yml
	$(NOECHO) $(ECHO) '  ExtUtils::MakeMaker: 0' >> META_new.yml
	$(NOECHO) $(ECHO) 'dynamic_config: 1' >> META_new.yml
	$(NOECHO) $(ECHO) 'generated_by: '\''ExtUtils::MakeMaker version 6.98, CPAN::Meta::Converter version 2.120630'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'license: perl' >> META_new.yml
	$(NOECHO) $(ECHO) 'meta-spec:' >> META_new.yml
	$(NOECHO) $(ECHO) '  url: http://module-build.sourceforge.net/META-spec-v1.4.html' >> META_new.yml
	$(NOECHO) $(ECHO) '  version: 1.4' >> META_new.yml
	$(NOECHO) $(ECHO) 'name: Pod-Generate-Recursive' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "Generate POD for directory contents. ",' >> META_new.json
	$(NOECHO) $(ECHO) '   "author" : [' >> META_new.json
	$(NOECHO) $(ECHO) '      "Adam M Dutko <addutko@cpan.org>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	$(NOECHO) $(ECHO) '   "dynamic_config" : 1,' >> META_new.json
	$(NOECHO) $(ECHO) '   "generated_by" : "ExtUtils::MakeMaker version 6.98, CPAN::Meta::Converter version 2.120630",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Pod-Generate-Recursive",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Generate POD for directory contents. </ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Adam M Dutko &lt;addutko@cpan.org&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Pod/Generate/Recursive.pm blib/lib/Pod/Generate/Recursive.pm 
